...
def plot_confusion_matrix(y_true, y_pred, predictions_dir):
    ...
    output_file = os.path.join(predictions_dir, "Confusion_Matrix1.png")
...
# Paths to your files
annotation_file = 'D:\\Menno\\Thesis\\Expirement\\Clustering - Varation 3\\Annotations\\annotations_cluster1.txt'
predictions_dir = 'C:\\Users\\Gebruiker\\Documents\\BirdNet Labbeling\\Clustering\\1\\'
...
precision, recall, accuracy = compute_metrics(TP, FP, TN, FN)
...
plot_confusion_matrix(y_true, y_pred, predictions_dir)
